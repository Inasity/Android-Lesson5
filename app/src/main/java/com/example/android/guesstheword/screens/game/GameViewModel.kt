...
class GameViewModel: ViewModel(){
    companion object {
        ...
        //Time for when the phone will start buzzing each second
    ...
    init {
        ...
        timer = object : CountDownTimer(COUNTDOWN_TIME, ONE_SECOND) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                //Log.i("GameViewModel", "Seconds remaining: " + millisUntilFinished/ ONE_SECOND)
    ...
    override fun onCleared() {
        ...
        Log.i("GameViewModel", "Timer destroyed.")
        timer.cancel()
    }
